...
public class Zergling extends BaseZergEnemy {
        ...
        public Zergling(Vector2D position) {
            super("Zergling","Zergling.png", position, BASE_MAX_HEALTH,BASE_SPEED, IMAGE_SCALE, BASE_MIN_ATTACK_RANGE, BASE_MAX_ATTACK_RANGE, BASE_DAMAGE, BASE_ATTACK_FREQUENCY, Races.TERRAN);
